...
const HeroImage = () => {
  return (
    <section className="flex flex-col items-center justify-center w-full h-full py-5 xl:pr-5">
      <section className="relative w-full h-full rounded-3xl">
        ...
        <div className="absolute bottom-0 left-0 bg-gradient-to-b from-[#23232300] to-[#232323] w-full h-96 px-10 pb-[37px] flex items-end justify-center rounded-b-3xl">
          <div className="flex flex-col items-start justify-center gap-3 w-full">
            <h1 className="text-[28px]/[130.8%] xl:text-[44px]/[130.8%] font-semibold text-white tracking-[-2%]">
              Realize o seu sonho com <br /> a ajuda da Tirar Visto!
            </h1>
            <p className="text-base/[130.8%] text-white tracking-[-2%] w-full xl:w-3/4">
