...
const MarketingContent = () => {
  return (
    <section className="flex flex-col items-center justify-center w-full xl:h-[344px] px-[60px] pt-[70px] pb-[72px] bg-[var(--bg-soft-color)]">
      <div className="relative w-full h-full">
        <h1 className="xl:absolute xl:top-0 xl:left-0 uppercase font-medium text-[24px]/[130.8%] mb-8 xl:mb-0 2xl:text-[56px]/[130.8%] tracking-[-6%] text-[var(--text-color)]">
          Consultoria completa para <br /> tirar seu visto
        </h1>
        <h1 className="xl:absolute xl:bottom-0 xl:right-0 uppercase italic font-medium text-[24px]/[130.8%]  2xl:text-[56px]/[130.8%] tracking-[-6%] text-[var(--text-color)]">
