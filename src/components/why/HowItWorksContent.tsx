    ...
    <section className="flex flex-col items-start justify-center w-full px-[60px] py-[95px] gap-[60px]">
      <div className="flex flex-col items-start justify-center gap-3 w-full">
        ...
        <div className="flex flex-row items-center justify-between gap-[74px] w-full ">
          <h1 className="text-[var(--text-color)] font-medium text-[56px]/[130.8%] tracking-[-7%] max-w-[500px] w-full">
      ...
      <div className="flex flex-row items-center justify-between gap-9 w-full">
        <picture className="w-3/5 rounded-[26px]">
          <Image
            src={familyTripImage}
            alt="Family trip"
        ...
        <div className="flex flex-col items-center justify-center w-2/5">
          ...
          <div className="flex flex-col items-start justify-between gap-3 px-3 py-5 w-full border-b-[1px] border-[var(--border-color)]">
            <h3 className="text-[var(--text-color)] font-medium text-[44px]/[130.8%] tracking-[-8%] w-full">
